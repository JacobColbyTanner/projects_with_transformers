...
model = Music_transformer_Model(n_embd, n_head, dropout, vocab_size, block_size, n_layer, device, use_relational_position=use_relational_position_embedding, use_relational_time_pitch=use_relational_time_and_pitch_embeddings)
